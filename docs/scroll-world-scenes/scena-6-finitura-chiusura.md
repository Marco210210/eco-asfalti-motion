# Scena 6 — Finitura e chiusura circolare
...
- **Audio**: nessuna narrazione, nessuna voce fuori campo, nessun dialogo,
  ...
  essere solo rumore ambientale realistico (traffico lontano, vento) — mai
...
Il primo fotogramma riprende da dove finiva la Scena 5: subito dietro il
rullo compattatore, sul tratto appena steso. Questa è l'**ultima** scena
della sequenza (nessuna scena successiva) — l'inquadratura finale deve
richiamare quella di apertura della Scena 0 (stessa altezza/angolo aereo
sulla campagna di Nocera Superiore), come chiusura visiva del cerchio.

Se il tool permette di partire da un'immagine (image-to-video), usa come
immagine di partenza l'ultimo fotogramma della Scena 5.

## La scena

Dietro il rullo, la segnaletica orizzontale bianca viene tracciata. La
camera si solleva in un pull-back aereo che rivela il tratto di strada nuova
che si allontana verso l'orizzonte, con qualche auto che inizia a
percorrerla. L'inquadratura finale richiama leggermente quella di apertura
della Scena 0 — un rimando visivo silenzioso al fatto che quella strada, un
giorno, tornerà fresato. Nessun testo bruciato: la suggestione resta visiva.
